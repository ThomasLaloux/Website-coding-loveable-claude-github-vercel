...
const en = {
  ...
  about: {
    h2: "About",
    paragraphs: [
      "Thomas is an independent automation consultant and developer focused on workflow automation, AI systems and data, with a business-first, pragmatic approach to delivery.",
...
const fr: Dict = {
  ...
  about: {
    h2: "À propos",
    paragraphs: [
      "Thomas est un consultant et dévelopeur indépendant en automatisation, spécialisé dans l'automatisation de workflows, les systèmes d'IA et la donnée, avec une approche pragmatique orientée business.",
