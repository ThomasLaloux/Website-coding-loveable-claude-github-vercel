...
const en = {
  ...
  about: {
    h2: "About",
    paragraphs: [
      "Thomas P. Laloux is an independent automation consultant and developer focused on workflow automation, AI systems and data, with a business-first, pragmatic approach to delivery.",
      ...
      "His current focus includes AI-powered workflow automation and agentic systems — combining multi-agent architectures, RAG, local and cloud LLMs, and human-in-the-loop control to solve operational and scaling challenges faced by startups, scale-ups, and financial firms.",
...
const fr: Dict = {
  ...
  about: {
    h2: "À propos",
    paragraphs: [
      "Thomas P. Laloux est un consultant et dévelopeur indépendant en automatisation, spécialisé dans l'automatisation de workflows, les systèmes d'IA et la donnée, avec une approche pragmatique orientée business.",
