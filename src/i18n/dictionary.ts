...
const en = {
  ...
  hero: {
    ...
    photoAlt:
      "Thomas Laloux — Independent AI Automation & Systematic Trading Engineer",
  },
  approach: {
  ...
  services: {
    ...
    cards: [
      ...
      {
        title: "Predictive Modeling and Data Analysis",
  ...
  about: {
    h2: "About",
    paragraphs: [
      "Thomas Laloux is an independent automation consultant and developer focused on workflow automation, AI systems and data, with a business-first, pragmatic approach to delivery.",
...
const fr: Dict = {
  ...
  hero: {
    ...
    photoAlt:
      "Thomas Laloux — Ingénieur indépendant en automatisation IA et trading systématique",
  },
  approach: {
  ...
  about: {
    h2: "À propos",
    paragraphs: [
      "Thomas Laloux est un consultant et dévelopeur indépendant en automatisation, spécialisé dans l'automatisation de workflows, les systèmes d'IA et la donnée, avec une approche pragmatique orientée business.",
